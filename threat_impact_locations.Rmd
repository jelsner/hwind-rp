...
Approximately 6 extra deaths per day during threat/impact/cleanup. What is the statistical significance of this difference? One way to answer this is to choose random dates and repeat to get a new difference
...
```{r}
for(k in 1:1){
set.seed(8967)  # for reproducibility
random_dates <- sample(all_dates, size = 24, replace = FALSE) # size is the number of hurricanes
