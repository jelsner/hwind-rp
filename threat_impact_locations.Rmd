...
## Merge with health outcome data
...
Approximately 6 extra deaths per day due to threat/impact/cleanup. What is the statistical significance of this difference? One way to answer this is to choose random dates and repeat to get a new difference. `Date0` in `Swaths.sf`
...
# Remove dates not occurring during the hurricane season June-November
all_dates <- seq.Date(from = start_date, to = end_date, by = "day")

# Randomly sample 10 dates from the range
set.seed(123)  # For reproducibility
random_dates <- sample(all_dates, size = 10, replace = FALSE)
